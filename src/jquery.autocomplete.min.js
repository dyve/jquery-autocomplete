...
a.length;if(0===b)return this.finish();var e=this,f=c("<ul></ul>"),g,h,j,i=!1,k=!1;for(g=0;g<b;g++)h=a[g],j=this.createItemFromResult(h),f.append(j),!1===i&&(i=""+h.value,k=j,j.addClass(this.options.firstItemClass)),g===b-1&&j.addClass(this.options.lastItemClass);this.position();this.dom.$results.html(f).show();this.options.autoWidth&&(f=this.dom.$elem.outerWidth()-this.dom.$results.outerWidth()+this.dom.$results.width(),this.dom.$results.css(this.options.autoWidth,f));c("li",this.dom.$results).hover(function(){e.focusItem(this)},
function(){});(this.autoFill(i,d)||this.options.selectFirst||this.options.selectOnly&&1===b)&&this.focusItem(k);this.active_=!0};c.Autocompleter.prototype.showResult=function(a,d){return c.isFunction(this.options.showResult)?this.options.showResult(a,d):a};c.Autocompleter.prototype.autoFill=function(a,c){var b,e,f,g;return this.options.autoFill&&8!==this.lastKeyPressed_&&(b=(""+a).toLowerCase(),e=(""+c).toLowerCase(),f=a.length,g=c.length,b.substr(0,g)===e)?(this.dom.$elem.val(a),this.selectRange(g,
