...
f,h,g,i;for(h=0;h<a.length;h++){g=a[h];i=typeof g;if(i==="string")e=g,f={};else if(c.isArray(g))e=g[0],f=g.slice(1);else if(i==="object")e=g.value,f=g.data;e=String(e);e>""&&(typeof f!=="object"&&(f={}),this.options.filterResults?(g=String(d),i=String(e),this.options.matchCase||(g=g.toLowerCase(),i=i.toLowerCase()),g=i.indexOf(g),g=this.options.matchInside?g>-1:g===0):g=!0,g&&b.push({value:e,data:f}))}this.options.sortResults&&(b=this.sortResults(b,d));if(this.options.maxItemsToShow>0&&this.options.maxItemsToShow<
...
d){var b=a.length;if(b===0)return this.finish();var e=this,f=c("<ul></ul>"),h,g,i,j=!1,k=!1;for(h=0;h<b;h++)g=a[h],i=c("<li>"+this.showResult(g.value,g.data)+"</li>"),i.data("value",g.value),i.data("data",g.data),i.click(function(){var a=c(this);e.selectItem(a)}).mousedown(function(){e.finishOnBlur_=!1}).mouseup(function(){e.finishOnBlur_=!0}),f.append(i),j===!1&&(j=String(g.value),k=i,i.addClass(this.options.firstItemClass)),h===b-1&&i.addClass(this.options.lastItemClass);this.position();this.dom.$results.html(f).show();
b=this.dom.$results.outerWidth()-this.dom.$results.width();this.dom.$results.width(this.dom.$elem.outerWidth()-b);c("li",this.dom.$results).hover(function(){e.focusItem(this)},function(){});this.autoFill(j,d)&&this.focusItem(k);this.active_=!0};c.Autocompleter.prototype.showResult=function(a,d){return c.isFunction(this.options.showResult)?this.options.showResult(a,d):a};c.Autocompleter.prototype.autoFill=function(a,d){var b,c,f,h;if(this.options.autoFill&&this.lastKeyPressed_!==8&&(b=String(a).toLowerCase(),
c=String(d).toLowerCase(),f=a.length,h=d.length,b.substr(0,h)===c))return this.dom.$elem.val(a),this.selectRange(h,f),!0;return!1};c.Autocompleter.prototype.focusNext=function(){this.focusMove(1)};c.Autocompleter.prototype.focusPrev=function(){this.focusMove(-1)};c.Autocompleter.prototype.focusMove=function(a){for(var d=c("li",this.dom.$results),a=parseInt(a,10),b=0;b<d.length;b++)if(c(d[b]).hasClass(this.selectClass_)){this.focusItem(b+a);return}this.focusItem(0)};c.Autocompleter.prototype.focusItem=
function(a){var d=c("li",this.dom.$results);d.length&&(d.removeClass(this.selectClass_).removeClass(this.options.selectClass),typeof a==="number"?(a=parseInt(a,10),a<0?a=0:a>=d.length&&(a=d.length-1),a=c(d[a])):a=c(a),a&&a.addClass(this.selectClass_).addClass(this.options.selectClass))};c.Autocompleter.prototype.selectCurrent=function(){var a=c("li."+this.selectClass_,this.dom.$results);a.length===1?this.selectItem(a):this.finish()};c.Autocompleter.prototype.selectItem=function(a){var c=a.data("value"),
a=a.data("data"),b=this.displayValue(c,a);this.lastSelectedValue_=this.lastProcessedValue_=b;this.dom.$elem.val(b).focus();this.setCaret(b.length);this.callHook("onItemSelect",{value:c,data:a});this.finish()};c.Autocompleter.prototype.displayValue=function(a,d){return c.isFunction(this.options.displayValue)?this.options.displayValue(a,d):a};c.Autocompleter.prototype.finish=function(){this.keyTimeout_&&clearTimeout(this.keyTimeout_);this.dom.$elem.val()!==this.lastSelectedValue_&&(this.options.mustMatch&&
this.dom.$elem.val(""),this.callHook("onNoMatch"));this.dom.$results.hide();this.lastProcessedValue_=this.lastKeyPressed_=null;this.active_&&this.callHook("onFinish");this.active_=!1};c.Autocompleter.prototype.selectRange=function(a,c){var b=this.dom.$elem.get(0);b.setSelectionRange?(b.focus(),b.setSelectionRange(a,c)):this.createTextRange&&(b=this.createTextRange(),b.collapse(!0),b.moveEnd("character",c),b.moveStart("character",a),b.select())};c.Autocompleter.prototype.setCaret=function(a){this.selectRange(a,
a)};c.fn.autocomplete=function(a){typeof a==="string"&&(a={url:a});var d=c.extend({},c.fn.autocomplete.defaults,a);return this.each(function(){var a=c(this),e=new c.Autocompleter(a,d);a.data("autocompleter",e)})};c.fn.autocomplete.defaults={inputClass:"acInput",loadingClass:"acLoading",resultsClass:"acResults",selectClass:"acSelect",queryParamName:"q",limitParamName:"limit",extraParams:{},lineSeparator:"\n",cellSeparator:"|",minChars:2,maxItemsToShow:10,delay:400,useCache:!0,maxCacheLength:10,matchSubset:!0,
matchCase:!1,matchInside:!0,mustMatch:!1,selectFirst:!1,selectOnly:!1,showResult:null,preventDefaultReturn:!0,preventDefaultTab:!1,onItemSelect:null,autoFill:!1,filterResults:!0,sortResults:!0,sortFunction:null,onNoMatch:null,onFinish:null}})(jQuery);